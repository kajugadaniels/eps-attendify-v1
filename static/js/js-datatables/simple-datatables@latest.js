            ...
            (function(t) {
                (function() {
                    ...
                    const e = t => "[object Object]" === Object.prototype.toString.call(t)
                      ...
                      , a = t => ["#text", "#comment"].includes(t.nodeName) ? t.data : t.childNodes ? t.childNodes.map((t => a(t))).join("") : ""
                      , o = function(t) {
                    ...
                    function d(t, e, s) {
                        var i;
                        return "#text" === t.nodeName ? i = s.document.createTextNode(t.data) : "#comment" === t.nodeName ? i = s.document.createComment(t.data) : (e ? i = s.document.createElementNS("http://www.w3.org/2000/svg", t.nodeName) : "svg" === t.nodeName.toLowerCase() ? (i = s.document.createElementNS("http://www.w3.org/2000/svg", "svg"),
                        e = !0) : i = s.document.createElement(t.nodeName),
                        t.attributes && Object.entries(t.attributes).forEach((function(t) {
                            var e = t[0]
                              , s = t[1];
                        ...
                        s.valueDiffing && (t.value && (i instanceof HTMLButtonElement || i instanceof HTMLDataElement || i instanceof HTMLInputElement || i instanceof HTMLLIElement || i instanceof HTMLMeterElement || i instanceof HTMLOptionElement || i instanceof HTMLProgressElement || i instanceof HTMLParamElement) && (i.value = t.value),
                    ...
                    function h(t, e, s) {
                        var i, n, a, o = e[s._const.action], r = e[s._const.route];
                        ...
                        case s._const.modifyAttribute:
                            ...
                            i instanceof HTMLInputElement && "value" === e[s._const.name] && (i.value = e[s._const.newValue]);
                            break;
                        ...
                        case s._const.replaceElement:
                            i.parentNode.replaceChild(d(e[s._const.newValue], "svg" === e[s._const.newValue].nodeName.toLowerCase(), s), i);
                            break;
                        ...
                        case s._const.addElement:
                            ...
                            if (!((i = c(t, u))instanceof Element))
                                return !1;
                            i.insertBefore(d(e[s._const.element], "http://www.w3.org/2000/svg" === i.namespaceURI, s), i.childNodes[h] || null);
                            break;
                        ...
                        case s._const.addTextElement:
                            var u;
                            if (h = (u = r.slice()).splice(u.length - 1, 1)[0],
                    ...
                    var p = function(t) {
                        ...
                        "#text" !== t.nodeName && "#comment" !== t.nodeName && t.attributes && (t.attributes.class && e.push("".concat(t.nodeName, ".").concat(t.attributes.class.replace(/ /g, "."))),
                      ...
                      , b = function(t) {
                        ...
                        return Object.prototype.hasOwnProperty.call(t, "attributes") && (e.attributes = t.attributes),
                        ...
                        Object.prototype.hasOwnProperty.call(t, "childNodes") && (e.childNodes = t.childNodes.map((function(t) {
                            return b(t)
                        }
                        ))),
                        e
                      ...
                      , v = function(t, e) {
                        ...
                        if (t.childNodes) {
                            if (t.childNodes.length !== e.childNodes.length)
                                return !1;
                      ...
                      , w = function(t, e, s, i, n) {
                        ...
                        if (t.attributes && e.attributes) {
                            if (t.attributes.id) {
                                if (t.attributes.id !== e.attributes.id)
                                    return !1;
                                if ("".concat(t.nodeName, "#").concat(t.attributes.id)in s)
                                    return !0
                            }
                            if (t.attributes.class && t.attributes.class === e.attributes.class && "".concat(t.nodeName, ".").concat(t.attributes.class.replace(/ /g, "."))in s)
                                return !0
                        }
                        if (i)
                            return !0;
                      ...
                      , y = function(t, e) {
                        for (var s = t.childNodes ? t.childNodes : [], i = e.childNodes ? e.childNodes : [], n = _(s.length, !1), a = _(i.length, !1), o = [], r = function() {
                            return arguments[1]
                        }, l = !1, d = function() {
                            var t = function(t, e, s, i) {
                                ...
                                c && t.some((function(t, s) {
                                    var i = p(t)
                                      , n = p(e[s]);
                                    return i.length !== n.length ? (c = !1,
                                    !0) : (i.some((function(t, e) {
                                        if (t !== n[e])
                                            return c = !1,
                                            !0
                                    }
                                ...
                                for (var h = 0; h < o; h++)
                                    for (var u = t[h], f = 0; f < r; f++) {
                                        var g = e[f];
                                        s[h] || i[f] || !w(u, g, d, c) ? l[h + 1][f + 1] = 0 : (l[h + 1][f + 1] = l[h][f] ? l[h][f] + 1 : 1,
                                        l[h + 1][f + 1] >= n && (n = l[h + 1][f + 1],
                                        a = [h + 1, f + 1]))
                                    }
                                return 0 !== n && {
                                    oldValue: a[0] - n,
                            ...
                            t ? (o.push(t),
                            Array.apply(void 0, new Array(t.length)).map(r).forEach((function(e) {
                                return function(t, e, s, i) {
                                    t[s.oldValue + i] = !0,
                                    e[s.newValue + i] = !0
                                }(n, a, t, e)
                                ...
                                case s._const.relocateGroup:
                                    ...
                                    n.subsets && n.subsets.forEach((function(t) {
                                        if (e[s._const.from] < e[s._const.to] && t.oldValue <= e[s._const.to] && t.oldValue > e[s._const.from])
                                            ...
                                            (i = t.oldValue + t.length - e[s._const.to]) > 0 && (c.push({
                                            ...
                                            t.oldValue === e[s._const.from] && (t.oldValue = e[s._const.to])
                                    }
                                    ));
                                    break;
                                case s._const.removeElement:
                                    a.childNodes.splice(o, 1),
                                    a.subsets && a.subsets.forEach((function(t) {
                    ...
                    function E(t, e) {
                        ...
                        return t instanceof Text || t instanceof Comment ? s.data = t.data : (t.attributes && t.attributes.length > 0 && (s.attributes = {},
                        Array.prototype.slice.call(t.attributes).forEach((function(t) {
                            return s.attributes[t.name] = t.value
                        }
                        ))),
                        t instanceof HTMLTextAreaElement ? s.value = t.value : t.childNodes && t.childNodes.length > 0 && (s.childNodes = [],
                        Array.prototype.slice.call(t.childNodes).forEach((function(t) {
                            return s.childNodes.push(E(t, e))
                        }
                        ))),
                        e.valueDiffing && (t instanceof HTMLInputElement && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : (t instanceof HTMLButtonElement || t instanceof HTMLDataElement || t instanceof HTMLInputElement || t instanceof HTMLLIElement || t instanceof HTMLMeterElement || t instanceof HTMLOptionElement || t instanceof HTMLProgressElement || t instanceof HTMLParamElement) && (s.value = t.value),
                    ...
                    var L = {
                      ...
                      , S = function(t) {
                        var e = {
                          ...
                          , s = !1
                          , i = t.match(/<\/?([^\s]+?)[/\s>]/);
                        if (i && (e.nodeName = i[1].toUpperCase(),
                        ...
                        for (var a = new RegExp($), o = null, r = !1; !r; )
                            if (null === (o = a.exec(t)))
                                ...
                                if (o[1]) {
                                    ...
                                    o[2] && (e.attributes[o[2]] = o[3].trim().substring(1, o[3].length - 1));
                        return {
                            type: "tag",
                            node: e,
                            voidElement: s
                      ...
                      , k = function(t, e) {
                        ...
                        return t.replace(O, (function(r, l) {
                            if (o) {
                                if (r !== "</".concat(s.node.nodeName, ">"))
                                    return "";
                                o = !1
                            }
                            var d = "/" !== r.charAt(1)
                            ...
                            if (c) {
                                ...
                                if (n < 0)
                                    ...
                                    "";
                                var f = a[n];
                                return f && p.nodeName && (f.node.childNodes || (f.node.childNodes = []),
                            ...
                            if (d) {
                                s = S(r),
                                n++,
                                "tag" === s.type && e.components[s.node.nodeName] && (s.type = "component",
                                o = !0),
                                s.voidElement || o || !u || "<" === u || (s.node.childNodes || (s.node.childNodes = []),
                                ...
                                var m = a[n - 1];
                                m && s.node.nodeName && (m.node.childNodes || (m.node.childNodes = []),
                                m.node.childNodes.push(s.node)),
                                a[n] = s
                            }
                            if ((!d || s.voidElement) && (n > -1 && (s.voidElement || s.node.nodeName === r.slice(2, -1).toUpperCase()) && --n > -1 && (s = a[n]),
                            !o && "<" !== u && u)) {
                      ...
                      , T = function() {
                        function t(t, e, s) {
                            this.options = s,
                            this.t1 = "undefined" != typeof Element && t instanceof Element ? E(t, this.options) : "string" == typeof t ? k(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2 = "undefined" != typeof Element && e instanceof Element ? E(e, this.options) : "string" == typeof e ? k(e, this.options) : JSON.parse(JSON.stringify(e)),
                            this.diffcount = 0,
                            this.foundAll = !1,
                            this.debug && (this.t1Orig = "undefined" != typeof Element && t instanceof Element ? E(t, this.options) : "string" == typeof t ? k(t, this.options) : JSON.parse(JSON.stringify(t)),
                            this.t2Orig = "undefined" != typeof Element && e instanceof Element ? E(e, this.options) : "string" == typeof e ? k(e, this.options) : JSON.parse(JSON.stringify(e))),
                            this.tracker = new x
                        }
                        ...
                        t.prototype.findDiffs = function(t, e) {
                            ...
                            do {
                                ...
                                0 === (s = this.findNextDiff(t, e, [])).length && (v(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0,
                                g(t),
                                s = this.findNextDiff(t, e, [])))),
                                s.length > 0 && (this.foundAll = !1,
                                this.tracker.add(s),
                                M(t, s, this.options))
                            } while (s.length > 0);
                        ...
                        t.prototype.findNextDiff = function(t, e, s) {
                            var i, n;
                            if (this.options.maxDepth && s.length > this.options.maxDepth)
                                return [];
                            if (!t.outerDone) {
                                if (i = this.findOuterDiff(t, e, s),
                                this.options.filterOuterDiff && (n = this.options.filterOuterDiff(t, e, i)) && (i = n),
                                i.length > 0)
                        ...
                        t.prototype.findOuterDiff = function(t, e, s) {
                            ...
                            if (t.nodeName !== e.nodeName) {
                                ...
                                return [(new N).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, b(t)).setValue(this.options._const.newValue, b(e)).setValue(this.options._const.route, s)]
                            }
                            ...
                            if (Object.prototype.hasOwnProperty.call(t, "data") && t.data !== e.data)
                                return "#text" === t.nodeName ? [(new N).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)] : [(new N).setValue(this.options._const.action, this.options._const.modifyComment).setValue(this.options._const.route, s).setValue(this.options._const.oldValue, t.data).setValue(this.options._const.newValue, e.data)];
                            for (n = t.attributes ? Object.keys(t.attributes).sort() : [],
                            a = e.attributes ? Object.keys(e.attributes).sort() : [],
                            o = n.length,
                            l = 0; l < o; l++)
                                i = n[l],
                                -1 === (r = a.indexOf(i)) ? d.push((new N).setValue(this.options._const.action, this.options._const.removeAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, t.attributes[i])) : (a.splice(r, 1),
                                t.attributes[i] !== e.attributes[i] && d.push((new N).setValue(this.options._const.action, this.options._const.modifyAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.oldValue, t.attributes[i]).setValue(this.options._const.newValue, e.attributes[i])));
                            for (o = a.length,
                            l = 0; l < o; l++)
                                i = a[l],
                                d.push((new N).setValue(this.options._const.action, this.options._const.addAttribute).setValue(this.options._const.route, s).setValue(this.options._const.name, i).setValue(this.options._const.value, e.attributes[i]));
                            return d
                        }
                        ,
                                ...
                                u && p)
                                    if (!this.options.maxChildCount || a < this.options.maxChildCount)
                                        ...
                                        if (i.length > n.length)
                                            ...
                                            var f = b(p);
                                            r = r.concat([(new N).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.element, f).setValue(this.options._const.route, s.concat(l))]),
                                            i.splice(h, 0, f),
                                            o -= 1
                                        } else
                                            r = r.concat([(new N).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, b(u)).setValue(this.options._const.newValue, b(p)).setValue(this.options._const.route, s.concat(l))]);
                                l += 1
                            }
                        ...
                        t.prototype.attemptGroupRelocation = function(t, e, s, i, n) {
                            for (var a, o, r, l, d, c, h = function(t, e, s) {
                                ...
                                return s.forEach((function(t) {
                                    for (var e = t.oldValue + t.length, s = t.newValue + t.length, o = t.oldValue; o < e; o += 1)
                                        i[o] = a;
                                    for (o = t.newValue; o < s; o += 1)
                                        n[o] = a;
                                    a += 1
                                }
                                )),
                            ...
                            }(t, e, s), u = h.gaps1, p = h.gaps2, f = Math.min(u.length, p.length), m = [], g = 0, v = 0; g < f; v += 1,
                            g += 1)
                                if (!n || !0 !== u[g] && !0 !== p[g])
                                    if (!0 === u[g])
                                        if ("#text" === (l = t.childNodes[v]).nodeName)
                                            if ("#text" === e.childNodes[g].nodeName) {
                                                if (l.data !== e.childNodes[g].data) {
                                                    for (c = v; t.childNodes.length > c + 1 && "#text" === t.childNodes[c + 1].nodeName; )
                                                        if (c += 1,
                                                        e.childNodes[g].data === t.childNodes[c].data) {
                                                            d = !0;
                                                            break
                                                        }
                                                    if (!d)
                                                        return m.push((new N).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, e.childNodes[g].data)),
                                                        m
                                                }
                                            } else
                                                m.push((new N).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.value, l.data)),
                                                u.splice(g, 1),
                                                f = Math.min(u.length, p.length),
                                                g -= 1;
                                        else
                                            m.push((new N).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.element, b(l))),
                                            u.splice(g, 1),
                                            f = Math.min(u.length, p.length),
                                            g -= 1;
                                    else if (!0 === p[g])
                                        "#text" === (l = e.childNodes[g]).nodeName ? (m.push((new N).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.value, l.data)),
                                        u.splice(g, 0, !0),
                                        f = Math.min(u.length, p.length),
                                        v -= 1) : (m.push((new N).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(g)).setValue(this.options._const.element, b(l))),
                                        u.splice(g, 0, !0),
                                        f = Math.min(u.length, p.length),
                                        v -= 1);
                                    else if (u[g] !== p[g]) {
                                        ...
                                        (o = Math.min(r.newValue, t.childNodes.length - r.length)) !== r.oldValue) {
                                            ...
                                            if (a)
                                                return [(new N).setValue(this.options._const.action, this.options._const.relocateGroup).setValue(this.options._const.groupLength, r.length).setValue(this.options._const.from, r.oldValue).setValue(this.options._const.to, o).setValue(this.options._const.route, i)]
                                        }
                                    }
                            return m
                        }
                        ...
                        t.prototype.findValueDiff = function(t, e, s) {
                            var i = [];
                            return t.selected !== e.selected && i.push((new N).setValue(this.options._const.action, this.options._const.modifySelected).setValue(this.options._const.oldValue, t.selected).setValue(this.options._const.newValue, e.selected).setValue(this.options._const.route, s)),
                            (t.value || e.value) && t.value !== e.value && "OPTION" !== t.nodeName && i.push((new N).setValue(this.options._const.action, this.options._const.modifyValue).setValue(this.options._const.oldValue, t.value || "").setValue(this.options._const.newValue, e.value || "").setValue(this.options._const.route, s)),
                            t.checked !== e.checked && i.push((new N).setValue(this.options._const.action, this.options._const.modifyChecked).setValue(this.options._const.oldValue, t.checked).setValue(this.options._const.newValue, e.checked).setValue(this.options._const.route, s)),
                            i
                        }
                        ,
                        t
                    ...
                    const H = (t, e, s, {classes: i, format: n, hiddenHeader: a, sortable: o, scrollY: r, type: l}, {noColumnWidths: d, unhideHeader: c}) => ({
                        nodeName: "TR",
                        childNodes: t.map(( (t, h) => {
                            ...
                            if (u.hidden)
                                return;
                            const p = {};
                            if (u.sortable && o && (!r.length || c) && (u.filter ? p["data-filterable"] = "true" : p["data-sortable"] = "true"),
                      ...
                      , R = (t, e, s, i, n, a, {classes: o, hiddenHeader: r, header: l, footer: d, format: c, sortable: h, scrollY: u, type: p, rowRender: f, tabIndex: m}, {noColumnWidths: g, unhideHeader: b, renderHeader: v}) => {
                        const w = {
                            nodeName: "TABLE",
                            attributes: {
                                ...t
                                ...
                                childNodes: s.map(( ({row: t, index: e}) => {
                                    const s = {
                                        ...
                                        childNodes: t.map(( (t, s) => {
                                            ...
                                            a.cellClass && (o.attributes || (o.attributes = {}),
                                    ...
                                    if (e === a && (s.attributes.class = o.cursor),
                                    f) {
                                        const i = f(t, s, e);
                                        if (i) {
                                            if ("string" != typeof i)
                        ...
                        if (w.attributes.class = w.attributes.class ? `${w.attributes.class} ${o.table}` : o.table,
                        l || d || v) {
                            const t = H(e, i, n, {
                                classes: o,
                                hiddenHeader: r,
                        ...
                        return !1 !== m && (w.attributes.tabindex = String(m)),
                        w
                    }
                    ;
                        ...
                        var D = function() {
                            ...
                            g.startOf = function(t, e) {
                                var s = this
                                  ...
                                  , f = function(t, e) {
                                    return N.w(s.toDate()[t].apply(s.toDate("s"), (d ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), s)
                                }
                                  , m = this.$W
                                  , g = this.$M
                                  , b = this.$D
                            ...
                            ,
                            g.$set = function(t, e) {
                                var r, d = N.p(t), u = "set" + (this.$u ? "UTC" : ""), p = (r = {},
                                r[o] = u + "Date",
                                r[h] = u + "Date",
                                r[l] = u + "Month",
                                r[c] = u + "FullYear",
                            ...
                            g.diff = function(s, h, u) {
                                var p, f = N.p(h), m = x(s), g = (m.utcOffset() - this.utcOffset()) * t, b = this - m, v = N.m(this, m);
                                return v = (p = {},
                                p[c] = v / 12,
                                p[l] = v,
                                p[d] = v / 3,
                          ...
                          , M = D.prototype;
                        return x.prototype = M,
                        [["$ms", s], ["$s", i], ["$m", n], ["$H", a], ["$W", o], ["$M", l], ["$y", c], ["$D", h]].forEach((function(t) {
                            M[t[1]] = function(e) {
                        ...
                        function u(s) {
                            ...
                            return function(t) {
                                ...
                                return function(t) {
                                    ...
                                    if (void 0 !== e) {
                                        var s = t.hours;
                                        e ? s < 12 && (t.hours += 12) : 12 === s && (t.hours = 0),
                                        delete t.afternoon
                                    }
                                }(e),
                                e
                    ...
                    const U = (t, e) => {
                      ...
                      , z = (t, e) => {
                        if (t?.constructor === Object && Object.prototype.hasOwnProperty.call(t, "data") && !Object.keys(t).find((t => !["text", "order", "data"].includes(t))))
                            return t;
                        const s = {
                            data: t
                        };
                        switch (e.type) {
                        case "string":
                            "string" != typeof t && (s.text = String(s.data),
                            s.order = s.text);
                            break;
                        case "date":
                      ...
                      , J = t => {
                        if (t instanceof Object && t.constructor === Object && t.hasOwnProperty("data") && ("string" == typeof t.text || "string" == typeof t.data))
                            return t;
                        const e = {
                            data: t
                        };
                      ...
                      , W = (t, e, s, i, n) => {
                        ...
                        t.headings ? o.headings = t.headings.map((t => J(t))) : e?.tHead ? o.headings = Array.from(e.tHead.querySelectorAll("th")).map(( (t, e) => {
                            const o = (t => {
                                const e = E(t, {
                                    valueDiffing: !1
                                });
                            ...
                            const r = s[e];
                            return "false" !== t.dataset.sortable?.trim().toLowerCase() && "false" !== t.dataset.sort?.trim().toLowerCase() || (r.sortable = !1),
                            ...
                            ["number", "string", "html", "date", "boolean", "other"].includes(t.dataset.type) && (r.type = t.dataset.type,
                            "date" === r.type && t.dataset.format && (r.format = t.dataset.format)),
                            o
                        }
                        )) : t.data?.length ? o.headings = t.data[0].map((t => J(""))) : e?.tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t => J(""))));
                        ...
                        if (t.data ? o.data = t.data.map((t => t.map(( (t, e) => z(t, s[e]))))) : e?.tBodies?.length && (o.data = Array.from(e.tBodies[0].rows).map((t => Array.from(t.cells).map(( (t, e) => {
                            ...
                            return t.dataset.order && (i.order = isNaN(parseFloat(t.dataset.order)) ? t.dataset.order : parseFloat(t.dataset.order)),
                            i
                        }
                        ))))),
                    ...
                    class Z {
                            ...
                            [this.settings,this._state] = ( (t=[], e, s) => {
                                ...
                                return t.forEach((t => {
                                    (Array.isArray(t.select) ? t.select : [t.select]).forEach((o => {
                                        ...
                                        !1 === t.sortable ? r.sortable = !1 : (t.numeric && (r.numeric = t.numeric),
                        ...
                        visible(t) {
                            return void 0 === t && (t = [...Array(this.dt.data.headings.length).keys()]),
                            Array.isArray(t) ? t.map((t => !this.settings[t]?.hidden)) : !this.settings[t]?.hidden
                        }
                        add(t) {
                            const e = this.dt.data.headings.length;
                            if (this.dt.data.headings = this.dt.data.headings.concat([J(t.heading)]),
                            ...
                            t.type || t.format || t.sortable || t.render || t.filter) {
                                ...
                                !1 === t.sortable ? s.sortable = !1 : (t.numeric && (s.numeric = t.numeric),
                        ...
                        filter(t, e=!1) {
                            ...
                            if (s) {
                                let e = !1;
                                i = this.settings[t].filter.find((t => !!e || (t === s && (e = !0),
                                !1)))
                            } else {
                        ...
                        sort(t, e, s=!1) {
                            ...
                            if (s || this.dt.emit("datatable.sorting", t, e),
                            !e) {
                            ...
                            this.dt._searchQueries.length ? (this.dt.multiSearch(this.dt._searchQueries),
                            this.dt.emit("datatable.sort", t, e)) : s || (this.dt._currentPage = 1,
                            this.dt.update(),
                    ...
                    const X = {
                      ...
                      , K = {
                        ...
                        menuItems: [{
                            ...
                            action: (t, e) => {
                                if (!(t.event.target instanceof Element))
                                    return;
                    ...
                    class tt {
                        ...
                        init() {
                            this.initialized || (this.dt.wrapperDOM.classList.add(this.options.classes.editable),
                            this.options.inline && (this.originalRowRender = this.dt.options.rowRender,
                            this.dt.options.rowRender = (t, e, s) => {
                                let i = this.rowRender(t, e, s);
                                return this.originalRowRender && (i = this.originalRowRender(t, i, s)),
                                i
                            }
                            ),
                            this.options.contextMenu && (this.containerDOM = n("div", {
                            ...
                            this.options.menuItems && this.options.menuItems.length && this.options.menuItems.forEach((t => {
                                ...
                                if (!t.separator) {
                                    ...
                                    e.appendChild(s),
                                    t.action && "function" == typeof t.action && s.addEventListener("click", (e => {
                                        e.preventDefault(),
                                        t.action(this, e)
                                    }
                                    ))
                        ...
                        bindEvents() {
                            ...
                            this.options.contextMenu && (this.dt.dom.addEventListener("contextmenu", this.events.context),
                        ...
                        editCellModal() {
                            const t = this.data.cell
                              ...
                              , i = [`<div class='${this.options.classes.inner}'>`, `<div class='${this.options.classes.header}'>`, `<h4>${this.options.labels.editCell}</h4>`, `<button class='${this.options.classes.close}' type='button' data-editor-close>${this.options.labels.closeX}</button>`, " </div>", `<div class='${this.options.classes.block}'>`, `<form class='${this.options.classes.form}'>`, `<div class='${this.options.classes.row}'>`, `<label class='${this.options.classes.label}'>${o(s)}</label>`, `<input class='${this.options.classes.input}' value='${o(t.text || String(t.data) || "")}' type='text'>`, "</div>", `<div class='${this.options.classes.row}'>`, `<button class='${this.options.classes.save}' type='button' data-editor-save>${this.options.labels.save}</button>`, "</div>", "</form>", "</div>", "</div>"].join("")
                              , a = n("div", {
                            ...
                            a.addEventListener("click", (t => {
                                ...
                                if (e instanceof Element)
                                    if (e.hasAttribute("data-editor-close")) {
                                        if (t.preventDefault(),
                                        !this.options.closeModal(this))
                                            return;
                                        this.closeModal()
                                    } else
                                        e.hasAttribute("data-editor-save") && (t.preventDefault(),
                        ...
                        saveCell(t) {
                            ...
                            this.dt.data.data[this.data.rowIndex][this.data.columnIndex] = n,
                            this.closeModal();
                        ...
                        editRowModal() {
                            const t = this.data.row
                              , e = [`<div class='${this.options.classes.inner}'>`, `<div class='${this.options.classes.header}'>`, `<h4>${this.options.labels.editRow}</h4>`, `<button class='${this.options.classes.close}' type='button' data-editor-close>${this.options.labels.closeX}</button>`, " </div>", `<div class='${this.options.classes.block}'>`, `<form class='${this.options.classes.form}'>`, `<div class='${this.options.classes.row}'>`, `<button class='${this.options.classes.save}' type='button' data-editor-save>${this.options.labels.save}</button>`, "</div>", "</form>", "</div>", "</div>"].join("")
                              , s = n("div", {
                                class: this.options.classes.modal,
                                html: e
                            })
                            ...
                            t.forEach(( (t, e) => {
                                const s = this.dt.columns.settings[e];
                                if ((!s.hidden || s.hidden && this.options.hiddenColumns) && !this.options.excludeColumns.includes(e)) {
                                    const s = this.dt.data.headings[e].text || String(this.dt.data.headings[e].data);
                                    a.insertBefore(n("div", {
                                        class: this.options.classes.row,
                                        html: [`<div class='${this.options.classes.row}'>`, `<label class='${this.options.classes.label}'>${o(s)}</label>`, `<input class='${this.options.classes.input}' value='${o(t.text || String(t.data) || "")}' type='text'>`, "</div>"].join("")
                                    }), a.lastElementChild)
                                }
                            }
                            )),
                            ...
                            s.addEventListener("click", (t => {
                                const e = t.target;
                                e instanceof Element && (e.hasAttribute("data-editor-close") ? this.options.closeModal(this) && this.closeModal() : e.hasAttribute("data-editor-save") && this.saveRow(r.map((t => t.value.trim())), this.data.row))
                            }
                            ))
                        }
                        saveRow(t, e) {
                        ...
                        closeModal() {
                            this.editing && this.modalDOM && (document.body.removeChild(this.modalDOM),
                        ...
                        dismiss(t) {
                            ...
                            if (!(e instanceof Element) || this.wrapperDOM.contains(e))
                                return;
                            let s = !0;
                            this.options.contextMenu && this.editing && (s = !e.matches(`input.${this.options.classes.input}[type=text]`)),
                            s && this.closeMenu()
                        }
                        openMenu() {
                            if (this.editing && this.data && this.editingCell) {
                            ...
                            this.options.contextMenu && (document.body.appendChild(this.containerDOM),
                            this.closed = !1,
                            this.dt.emit("editable.context.open"))
                        }
                        closeMenu() {
                            this.options.contextMenu && !this.closed && (this.closed = !0,
                        ...
                        rowRender(t, e, s) {
                            return this.data && this.data.rowIndex === s ? (this.editingCell ? e.childNodes[l(this.data.columnIndex, this.dt.columns.settings)].childNodes = [{
                                nodeName: "INPUT",
                                attributes: {
                                    type: "text",
                                ...
                                const n = r(i, this.dt.columns.settings)
                                  , a = t[n];
                                this.options.excludeColumns.includes(n) || (e.childNodes[i].childNodes = [{
                                    nodeName: "INPUT",
                                    attributes: {
                                        type: "text",
                    ...
                    s.DataTable = class {
                        constructor(t, e={}) {
                            ...
                            s instanceof HTMLTableElement ? this.dom = s : (this.dom = document.createElement("table"),
                        ...
                        init() {
                            ...
                            this.data = W(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format),
                            this._render(),
                            setTimeout(( () => {
                        ...
                        _render() {
                            ...
                            Array.from(this.wrapperDOM.querySelectorAll(`.${this.options.classes.pagination}`)).forEach((t => {
                                t instanceof HTMLElement && (t.innerHTML = `<ul class="${this.options.classes.paginationList}"></ul>`,
                        ...
                        _renderTable(t={}) {
                            let e = R(this._tableAttributes, this.data.headings, (this.options.paging || this._searchQueries.length) && this._currentPage && this.pages.length && !t.noPaging ? this.pages[this._currentPage - 1] : this.data.data.map(( (t, e) => ({
                                row: t,
                                index: e
                        ...
                        _renderPage(t=!1) {
                            this.hasRows && this.totalPages ? (this._currentPage > this.totalPages && (this._currentPage = 1),
                            this._renderTable(),
                            this.onFirstPage = 1 === this._currentPage,
                            this.onLastPage = this._currentPage === this.lastPage) : this.setMessage(this.options.labels.noRows);
                            let e, s = 0, i = 0, n = 0;
                            if (this.totalPages && (s = this._currentPage - 1,
                            ...
                            if (1 == this._currentPage && this._fixHeight(),
                            this.options.rowNavigation && this._currentPage && (!this.rows.cursor || !this.pages[this._currentPage - 1].find((t => t.index === this.rows.cursor)))) {
                        ...
                        _renderPagers() {
                            ...
                            let t = ( (t, e, s, i, n) => {
                                let a = [];
                                if (n.firstLast && a.push(G(1, n.firstText, n)),
                                n.nextPrev) {
                                    const e = t ? 1 : s - 1;
                                    a.push(G(e, n.prevText, n, {
                                        hidden: t
                                    }))
                                }
                                let o = [...Array(i).keys()].map((t => G(t + 1, String(t + 1), n, {
                                    active: t === s - 1
                                })));
                                ...
                                n.nextPrev) {
                                    const t = e ? i : s + 1;
                                    a.push(G(t, n.nextText, n, {
                                        hidden: e
                                    }))
                                }
                                return n.firstLast && a.push(G(i, n.lastText, n)),
                                {
                                    nodeName: "UL",
                                    attributes: {
                        ...
                        _renderSeparateHeader() {
                            ...
                            this.headerDOM || (this.headerDOM = document.createElement("div"),
                            ...
                            let e = {
                                ...
                                childNodes: [{
                                    nodeName: "THEAD",
                                    childNodes: [H(this.data.headings, this.columns.settings, this.columns._state, this.options, {
                                        unhideHeader: !0
                                    })]
                                }]
                            };
                        ...
                        _bindEvents() {
                            ...
                            this.options.searchable && this.wrapperDOM.addEventListener("keyup", (t => {
                                const e = t.target;
                                if (!(e instanceof HTMLInputElement && e.matches(`.${this.options.classes.input}`)))
                                    return;
                                t.preventDefault();
                                const s = Array.from(this.wrapperDOM.querySelectorAll(`.${this.options.classes.input}`)).filter((t => t.value.length)).map((t => t.dataset.columns ? {
                                    term: t.value,
                            ...
                            this.options.rowNavigation ? (this.dom.addEventListener("keydown", (t => {
                                if ("ArrowUp" === t.key) {
                                    let e;
                                    t.preventDefault(),
                                    t.stopPropagation(),
                                    this.pages[this._currentPage - 1].find((t => t.index === this.rows.cursor || (e = t,
                                    !1))),
                                    e ? this.rows.setCursor(e.index) : this.onFirstPage || this.page(this._currentPage - 1, !0)
                                } else if ("ArrowDown" === t.key) {
                                    let e;
                                    t.preventDefault(),
                                    t.stopPropagation();
                                    const s = this.pages[this._currentPage - 1].find((t => !!e || (t.index === this.rows.cursor && (e = !0),
                                    !1)));
                                    s ? this.rows.setCursor(s.index) : this.onLastPage || this.page(this._currentPage + 1)
                                } else
                                    ["Enter", " "].includes(t.key) && this.emit("datatable.selectrow", this.rows.cursor, t)
                            }
                            )),
                        ...
                        destroy() {
                            this.options.destroyable && (this.dom.innerHTML = this._initialInnerHTML,
                        ...
                        _paginate() {
                            ...
                            return this._searchQueries.length && (t = [],
                            this._searchData.forEach((e => t.push({
                                index: e,
                        ...
                        _fixHeight() {
                            this.options.fixedHeight && (this.containerDOM.style.height = null,
                            this._rect = this.containerDOM.getBoundingClientRect(),
                        ...
                        multiSearch(t) {
                            ...
                            !(t = t.filter((t => t.term.length))).length)
                                ...
                                this.wrapperDOM.classList.remove("search-results"),
                                !1;
                            const e = t.map((t => this.columns.settings.map(( (e, s) => {
                                if (e.hidden || !e.searchable || t.columns && !t.columns.includes(s))
                                    return !1;
                                let i = t.term;
                                const n = e.sensitivity || this.options.sensitivity;
                                return ["base", "accent"].includes(n) && (i = i.toLowerCase()),
                                ["base", "case"].includes(n) && (i = i.normalize("NFD").replace(/\p{Diacritic}/gu, "")),
                                (e.ignorePunctuation || this.options.ignorePunctuation) && (i = i.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, "")),
                                i
                            }
                            ))));
                            this.data.data.forEach(( (t, s) => {
                                const i = t.map(( (t, e) => {
                                    ...
                                    if (s.length) {
                                        ...
                                        ["base", "case"].includes(i) && (s = s.normalize("NFD").replace(/\p{Diacritic}/gu, "")),
                            ...
                            this._searchData.length ? this.update() : (this.wrapperDOM.classList.remove("search-results"),
                            this.setMessage(this.options.labels.noResults)),
                            this.emit("datatable.multisearch", t, this._searchData)
                        }
                        page(t, e=!1) {
                            return t !== this._currentPage && (isNaN(t) || (this._currentPage = t),
                            !(t > this.pages.length || t < 0) && (this._renderPage(e),
                            this._renderPagers(),
                            ...
                            if (Array.isArray(t)) {
                                ...
                                t.forEach(( (t, i) => {
                                    ...
                                    Object.entries(t).forEach(( ([t,s]) => {
                                        const a = e.indexOf(t);
                                        a > -1 ? n[a] = z(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[e.length] = z(s, this.columns.settings[e.length]),
                                        e.push(t),
                                ...
                                e(t) && (!t.headings || this.hasHeadings || this.hasRows ? t.data && Array.isArray(t.data) && (s = t.data.map((t => t.map(( (t, e) => z(t, this.columns.settings[e])))))) : this.data = W(t, void 0, this.columns.settings, this.options.type, this.options.format));
                    ...
                    s.convertCSV = function(t) {
                        ...
                        if (i.data.length) {
                            ...
                            if (t.length && (i.headings && (s.headings = t[0].split(i.columnDelimiter),
                            i.removeDoubleQuotes && (s.headings = s.headings.map((t => t.trim().replace(/(^"|"$)/g, "")))),
                            t.shift()),
                            t.forEach(( (t, e) => {
                                s.data[e] = [];
                        ...
                        i.selection)
                            if (Array.isArray(i.selection))
                                for (let e = 0; e < i.selection.length; e++)
                                    a = a.concat(t.pages[i.selection[e] - 1].map((t => t.row.filter(( (t, e) => n(e))).map((t => t.text ?? t.data)))));
                            else
                                a = a.concat(t.pages[i.selection - 1].map((t => t.row.filter(( (t, e) => n(e))).map((t => t.text ?? t.data)))));
                        else
                            a = a.concat(t.data.data.map((t => t.filter(( (t, e) => n(e))).map((t => t.text ?? t.data)))));
                        if (a.length) {
                            let t = "";
                            if (a.forEach((e => {
                                e.forEach((e => {
                                    "string" == typeof e && (e = (e = (e = (e = (e = e.trim()).replace(/\s{2,}/g, " ")).replace(/\n/g, "  ")).replace(/"/g, '""')).replace(/#/g, "%23")).includes(",") && (e = `"${e}"`),
                    ...
                    s.exportJSON = function(t, s={}) {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection))
                                for (let e = 0; e < i.selection.length; e++)
                                    a = a.concat(t.pages[i.selection[e] - 1].map((t => t.row.filter(( (t, e) => n(e))).map((t => t.data)))));
                            else
                                a = a.concat(t.pages[i.selection - 1].map((t => t.row.filter(( (t, e) => n(e))).map((t => t.data)))));
                        else
                            a = a.concat(t.data.data.map((t => t.filter(( (t, e) => n(e))).map((t => t.data)))));
                    ...
                    s.makeEditable = function(t, e={}) {
                        const s = new tt(t,e);
                        return t.initialized ? s.init() : t.on("datatable.init", ( () => s.init())),
                        s
                    }
                }
                ).call(this)
