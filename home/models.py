...
class Employee(models.Model):
    ...
    week_ending = models.CharField(max_length=40, null=True, blank=True)
    budget_ref = models.CharField(max_length=40, null=True, blank=True)
    supervision = models.CharField(max_length=40, null=True, blank=True)
    field = models.CharField(max_length=40, null=True, blank=True)
    type = models.CharField(max_length=40, null=True, blank=True)
    nid = models.CharField(max_length=40, null=True, blank=True)
    rssb_number = models.CharField(max_length=40, null=True, blank=True)
    rate = models.CharField(max_length=40, null=True, blank=True)
    gross = models.CharField(max_length=40, null=True, blank=True)
